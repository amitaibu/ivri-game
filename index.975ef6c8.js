...
},{"./elm/Main.elm":"iRWCQ"}],"iRWCQ":[function(require,module,exports) {
(function(scope) {
    "use strict";
...
*/ var _Scheduler_working = false;
    ...
    var $ccapndave$elm_update_extra$Update$Extra$andThen = F3(function(update, msg, _v0) {
        var model = _v0.a;
        var cmd = _v0.b;
        var _v1 = A2(update, msg, model);
        var model_ = _v1.a;
        var cmd_ = _v1.b;
        return _Utils_Tuple2(model_, $elm$core$Platform$Cmd$batch(_List_fromArray([
            cmd,
            cmd_
        ])));
    });
    var $ccapndave$elm_update_extra$Update$Extra$sequence = F3(function(update, msgs, init) {
        var foldUpdate = $ccapndave$elm_update_extra$Update$Extra$andThen(update);
        return A3($elm$core$List$foldl, foldUpdate, init, msgs);
    });
    var $Gizra$elm_fetch$Update$Fetch$applyFetch = F3(function(fetch, update, resultSoFar) {
        var msgs = fetch(resultSoFar.a);
        return $elm$core$List$isEmpty(msgs) ? resultSoFar : A3($Gizra$elm_fetch$Update$Fetch$applyFetch, fetch, update, A3($ccapndave$elm_update_extra$Update$Extra$sequence, update, msgs, resultSoFar));
    });
    var $Gizra$elm_fetch$Update$Fetch$andThenFetch = F4(function(fetch, update, msg, model) {
        return A3($Gizra$elm_fetch$Update$Fetch$applyFetch, fetch, update, A2(update, msg, model));
    });
    ...
    var $author$project$Pages$Item$Fetch$fetch = F2(function(modelBackend, model) {
        return _List_Nil;
    });
    var $author$project$App$Fetch$fetch = function(model) {
        var _v0 = model.activePage;
        if (_v0.$ === "Item") return A2($elm$core$List$map, function(subMsg) {
            return $author$project$App$Model$MsgBackend(subMsg);
        }, A2($author$project$Pages$Item$Fetch$fetch, model.backend, model.itemPage));
    ...
    var $author$project$App$Types$English = {
        $: "English"
    };
    var $author$project$App$Types$NotFound = {
        $: "NotFound"
    };
    var $author$project$Pages$Item$Model$Independent = {
        $: "Independent"
    };
    var $author$project$Pages$Item$Model$countries = $elm$core$Dict$fromList(_List_fromArray([
        _Utils_Tuple2(1, {
            countryState: $author$project$Pages$Item$Model$Independent,
            flag: "\uD83C\uDDEE\uD83C\uDDF1",
            name: "Israel",
            population: 6
        }),
    ...
    var $author$project$Pages$Item$Model$players = $elm$core$Dict$fromList(_List_fromArray([
        _Utils_Tuple2(1, {
            age: 10,
            name: "Ivri"
        }),
    ...
    var $author$project$Pages$Item$Model$emptyModel = {
        countries: $author$project$Pages$Item$Model$countries,
        players: $author$project$Pages$Item$Model$players,
        selectedPlayer: $elm$core$Maybe$Nothing
    };
    ...
    var $author$project$App$Model$emptyModel = {
        ...
        errors: _List_Nil,
        itemPage: $author$project$Pages$Item$Model$emptyModel,
    ...
    var $author$project$App$Types$Item = {
        $: "Item"
    };
    var $author$project$App$Update$resolveActivePage = function(page) {
        if (page === "item") return $author$project$App$Types$Item;
        else return $author$project$App$Types$NotFound;
    };
    var $author$project$App$Update$init = function(flags) {
        var activePage = $author$project$App$Update$resolveActivePage(flags.page);
        var model = function(model_) {
            return _Utils_update(model_, {
                activePage: activePage
            });
        }($author$project$App$Model$emptyModel);
        var cmds = $elm$core$Platform$Cmd$batch(A2($elm$core$List$append, _List_fromArray([
            A2($elm$core$Task$perform, $author$project$App$Model$SetCurrentDate, $elm$time$Time$now)
        ]), A2($elm$core$List$map, A2($elm$core$Basics$composeR, $elm$core$Task$succeed, $elm$core$Task$perform($elm$core$Basics$identity)), $author$project$App$Fetch$fetch(model))));
    ...
    var $author$project$App$Model$MsgItemPage = function(a) {
        return {
            $: "MsgItemPage",
            a: a
        };
    };
    var $author$project$App$Model$PagesReturn = F4(function(model, cmd, error, appMsgs) {
        return {
            appMsgs: appMsgs,
            cmd: cmd,
            error: error,
    ...
    var $author$project$Pages$Item$Update$update = F3(function(modelBackend, msg, model) {
        ...
        if (msg.$ === "SetCountryState") {
            var countryId = msg.a;
            var countryState = msg.b;
            var _v1 = A2($elm$core$Dict$get, countryId, model.countries);
            if (_v1.$ === "Nothing") return noChange;
            else {
                var country = _v1.a;
                var countryUpdated = _Utils_update(country, {
                    countryState: countryState
                });
                var countriesUpdated = A3($elm$core$Dict$insert, countryId, countryUpdated, model.countries);
                return A4($author$project$App$Model$PagesReturn, _Utils_update(model, {
                    countries: countriesUpdated
                }), $elm$core$Platform$Cmd$none, $author$project$Error$Utils$noError, _List_Nil);
            }
        } else {
            var maybeSelectedPlayer = msg.a;
            return A4($author$project$App$Model$PagesReturn, _Utils_update(model, {
                selectedPlayer: maybeSelectedPlayer
            }), $elm$core$Platform$Cmd$none, $author$project$Error$Utils$noError, _List_Nil);
        }
    });
    var $author$project$Backend$Types$BackendReturn = F4(function(model, cmd, error, appMsgs) {
        return {
            appMsgs: appMsgs,
            cmd: cmd,
            error: error,
    ...
    var $author$project$Backend$Update$updateBackend = F3(function(currentDate, msg, model) {
        return A4($author$project$Backend$Types$BackendReturn, model, $elm$core$Platform$Cmd$none, $elm$core$Maybe$Nothing, _List_Nil);
    });
    var $elm_community$maybe_extra$Maybe$Extra$unwrap = F3(function(_default, f, m) {
        if (m.$ === "Nothing") return _default;
        else {
            var a = m.a;
            return f(a);
        }
    });
    var $author$project$App$Utils$handleErrors = F2(function(maybeError, model) {
        var errors = A3($elm_community$maybe_extra$Maybe$Extra$unwrap, model.errors, function(error) {
    ...
    var $author$project$App$Utils$updateSubModel = F6(function(subMsg, subModel, updateFunc, modelUpdateFunc, msg, model) {
        ...
        var appCmds = $elm$core$List$isEmpty(pagesReturn.appMsgs) ? $elm$core$Platform$Cmd$none : $elm$core$Platform$Cmd$batch(A2($elm$core$List$map, function(msg_) {
            return A2($elm$core$Task$perform, $elm$core$Basics$identity, $elm$core$Task$succeed(msg_));
        }, pagesReturn.appMsgs));
        return _Utils_Tuple2(A2(modelUpdateFunc, pagesReturn.model, modelUpdatedWithError), $elm$core$Platform$Cmd$batch(_List_fromArray([
            A2($elm$core$Platform$Cmd$map, msg, pagesReturn.cmd),
            appCmds
        ])));
    });
    var $author$project$App$Update$update = F2(function(msg, model) {
        switch(msg.$){
            case "NoOp":
                return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
            case "MsgBackend":
                var subMsg = msg.a;
                return A6($author$project$App$Utils$updateSubModel, subMsg, model.backend, F2(function(subMsg_, subModel) {
                    return A3($author$project$Backend$Update$updateBackend, model.currentDate, subMsg_, subModel);
                }), F2(function(subModel, model_) {
                    return _Utils_update(model_, {
                        backend: subModel
                    });
                }), function(subCmds) {
            ...
            case "MsgItemPage":
                var subMsg = msg.a;
                return A6($author$project$App$Utils$updateSubModel, subMsg, model.itemPage, F2(function(subMsg_, subModel) {
                    return A3($author$project$Pages$Item$Update$update, model.backend, subMsg_, subModel);
                }), F2(function(subModel, model_) {
                    return _Utils_update(model_, {
                        itemPage: subModel
                    });
                }), function(subCmds) {
                    return $author$project$App$Model$MsgItemPage(subCmds);
                }, model);
            case "SetActivePage":
    ...
    var $author$project$Translate$ErrorBadBody = function(a) {
        return {
            $: "ErrorBadBody",
            a: a
        };
    ...
    var $author$project$Translate$ErrorBadUrl = {
        $: "ErrorBadUrl"
    };
    var $author$project$Translate$ErrorNetworkError = {
        $: "ErrorNetworkError"
    };
    var $author$project$Translate$ErrorTimeout = {
        $: "ErrorTimeout"
    };
    ...
    var $author$project$Translate$translateHttpError = function(transId) {
        switch(transId.$){
            ...
            case "ErrorBadStatus":
                var _int = transId.a;
                return {
                    english: $elm$core$String$fromInt(_int)
                };
    ...
    var $author$project$Translate$translate = F2(function(language, trans) {
    ...
    var $author$project$Utils$WebData$errorString = F2(function(language, error) {
        switch(error.$){
            case "BadUrl":
                return A2($author$project$Translate$translate, language, $author$project$Translate$HttpError($author$project$Translate$ErrorBadUrl));
            case "NetworkError":
                return A2($author$project$Translate$translate, language, $author$project$Translate$HttpError($author$project$Translate$ErrorNetworkError));
            case "Timeout":
                return A2($author$project$Translate$translate, language, $author$project$Translate$HttpError($author$project$Translate$ErrorTimeout));
            case "BadStatus":
                var response = error.a;
                return A2($author$project$Translate$translate, language, $author$project$Translate$HttpError($author$project$Translate$ErrorBadStatus(response)));
            default:
                var str = error.a;
                return A2($author$project$Translate$translate, language, $author$project$Translate$HttpError($author$project$Translate$ErrorBadBody(str)));
        }
    });
    var $author$project$Utils$WebData$viewError = F2(function(language, error) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class("alert alert-danger")
        ]), _List_fromArray([
            $elm$html$Html$text(A2($author$project$Utils$WebData$errorString, language, error))
        ]));
    });
    var $author$project$Error$View$viewError = F2(function(language, error) {
        ...
        switch(_v0.$){
            case "Decoder":
                var err = _v0.a;
                return apply($elm$html$Html$text($elm$json$Json$Decode$errorToString(err)));
            case "Http":
                var err = _v0.a;
                return apply(A2($author$project$Utils$WebData$viewError, language, err));
            default:
                var txt = _v0.a;
                return apply($elm$html$Html$text(txt));
        }
    });
    var $author$project$Error$View$view = F2(function(language, errors) {
        return $elm$core$List$isEmpty(errors) ? $elm$html$Html$text("") : A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class("elm-errors alert debug-errors")
        ]), _List_fromArray([
            A2($elm$html$Html$ul, _List_Nil, A2($elm$core$List$map, $author$project$Error$View$viewError(language), errors))
        ]));
    });
    ...
    var $author$project$Pages$Item$Model$Conquered = function(a) {
        return {
            $: "Conquered",
            a: a
        };
    };
    var $author$project$Pages$Item$Model$SetCountryState = F2(function(a, b) {
        return {
            $: "SetCountryState",
            a: a,
            b: b
    ...
    var $author$project$Pages$Item$View$viewCountryStateButton = F2(function(maybeSelectedPlayer, _v0) {
        var countryId = _v0.a;
        var country = _v0.b;
        var _v1 = country.countryState;
        if (_v1.$ === "Independent") {
            if (maybeSelectedPlayer.$ === "Nothing") return $elm$html$Html$text("Please select a player");
            else {
                var playerId = maybeSelectedPlayer.a;
                return A2($elm$html$Html$button, _List_fromArray([
                    $elm$html$Html$Attributes$class("bg-red-300 py-2 px-4 rounded-full border border-red-400"),
                    $elm$html$Html$Events$onClick(A2($author$project$Pages$Item$Model$SetCountryState, countryId, $author$project$Pages$Item$Model$Conquered(playerId)))
                ]), _List_fromArray([
                    $elm$html$Html$text("Change to Conquered")
                ]));
            }
        } else {
            var playerId = _v1.a;
            return A2($elm$html$Html$button, _List_fromArray([
                $elm$html$Html$Attributes$class("bg-green-300 py-2 px-4 rounded-full border border-green-400"),
                $elm$html$Html$Events$onClick(A2($author$project$Pages$Item$Model$SetCountryState, countryId, $author$project$Pages$Item$Model$Independent))
            ]), _List_fromArray([
                $elm$html$Html$text("Change to Independent")
            ]));
        }
    });
    var $author$project$Pages$Item$View$viewCountry = F2(function(model, _v0) {
        var countryId = _v0.a;
        var country = _v0.b;
        var name = _List_fromArray([
            $elm$html$Html$text(country.flag),
            $elm$html$Html$text(" "),
            $elm$html$Html$text(country.name),
            $elm$html$Html$text(" ")
        ]);
        var _v1 = country.countryState;
        if (_v1.$ === "Independent") return A2($elm$core$List$append, name, _List_fromArray([
            $elm$html$Html$text("\uD83D\uDD4A️"),
            A2($author$project$Pages$Item$View$viewCountryStateButton, model.selectedPlayer, _Utils_Tuple2(countryId, country))
        ]));
        else {
            var playerId = _v1.a;
            var playerName = A2($elm$core$Maybe$withDefault, "", A2($elm$core$Maybe$map, function(player) {
                return player.name;
            }, A2($elm$core$Dict$get, playerId, model.players)));
            return A2($elm$core$List$append, name, _List_fromArray([
                $elm$html$Html$text("⚔️ - Conquered by " + playerName),
                A2($author$project$Pages$Item$View$viewCountryStateButton, model.selectedPlayer, _Utils_Tuple2(countryId, country))
            ]));
        }
    });
    var $author$project$Pages$Item$View$viewCountries = function(model) {
        return A2($elm$html$Html$ol, _List_fromArray([
            $elm$html$Html$Attributes$class("list-decimal flex flex-col gap-y-6")
        ]), A2($elm$core$List$map, function(_v0) {
            var countryId = _v0.a;
            var country = _v0.b;
            return A2($elm$html$Html$li, _List_fromArray([
                $elm$html$Html$Attributes$class("flex flex-row gap-4 items-center")
            ]), A2($author$project$Pages$Item$View$viewCountry, model, _Utils_Tuple2(countryId, country)));
        }, $elm$core$Dict$toList(model.countries)));
    };
    var $author$project$Pages$Item$Model$SetSelectedPlayer = function(a) {
        return {
            $: "SetSelectedPlayer",
            a: a
        };
    ...
    var $author$project$Pages$Item$View$viewPlayerButton = F2(function(maybeSelectedPlayer, _v0) {
        var playerId = _v0.a;
        var player = _v0.b;
        return A2($elm$html$Html$button, _List_fromArray([
            $elm$html$Html$Attributes$classList(_List_fromArray([
                _Utils_Tuple2("py-2 px-4 rounded-full border border-green-400", true),
                _Utils_Tuple2("bg-blue-300", _Utils_eq(maybeSelectedPlayer, $elm$core$Maybe$Just(playerId))),
                _Utils_Tuple2("bg-green-300", !_Utils_eq(maybeSelectedPlayer, $elm$core$Maybe$Just(playerId)))
            ])),
            $elm$html$Html$Events$onClick($author$project$Pages$Item$Model$SetSelectedPlayer($elm$core$Maybe$Just(playerId)))
        ]), _List_fromArray([
            $elm$html$Html$text(player.name)
        ]));
    });
    var $author$project$Pages$Item$View$viewPlayers = function(model) {
        return A2($elm$html$Html$ol, _List_fromArray([
            $elm$html$Html$Attributes$class("list-decimal")
        ]), A2($elm$core$List$map, function(_v0) {
            var playerId = _v0.a;
            var player = _v0.b;
            return A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                A2($author$project$Pages$Item$View$viewPlayerButton, model.selectedPlayer, _Utils_Tuple2(playerId, player))
            ]));
        }, $elm$core$Dict$toList(model.players)));
    };
    var $author$project$Pages$Item$View$view = F3(function(language, modelBackend, model) {
        return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class("bg-gray-50 px-5 md:px-10 py-10")
            ]), _List_fromArray([
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class("grid grid-cols-1 md:grid-cols-2 gap-8 md:max-w-3xl mx-auto")
                ]), _List_fromArray([
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        A2($elm$html$Html$h2, _List_fromArray([
                            ...
                            $elm$html$Html$text("Countries")
                        ])),
                        A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                            $author$project$Pages$Item$View$viewCountries(model)
                        ]))
                    ])),
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        A2($elm$html$Html$h2, _List_fromArray([
                        ...
                        A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                            $author$project$Pages$Item$View$viewPlayers(model)
                        ]))
                    ]))
                ]))
            ])),
            A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                $elm$html$Html$text("Selected player: " + $elm$core$Debug$toString(model.selectedPlayer))
            ]))
        ]));
    });
    var $author$project$App$View$view = function(model) {
        var _v0 = model.activePage;
        if (_v0.$ === "Item") return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
            A2($author$project$Error$View$view, model.language, model.errors),
            A2($elm$html$Html$map, $author$project$App$Model$MsgItemPage, A3($author$project$Pages$Item$View$view, model.language, model.backend, model.itemPage))
        ]));
    ...
    _Platform_export({
        "Main": {
            "init": $author$project$Main$main(A2($elm$json$Json$Decode$andThen, function(page) {
