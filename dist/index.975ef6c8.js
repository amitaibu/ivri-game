...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Pages$Item$Model$Conquered = {
        $: "Conquered"
    };
    ...
    var $author$project$Pages$Item$Model$countries = $elm$core$Dict$fromList(_List_fromArray([
        ...
        _Utils_Tuple2(3, {
            countryState: $author$project$Pages$Item$Model$Conquered,
            flag: "\uD83C\uDDEB\uD83C\uDDF7",
            name: "France",
            population: 20
        })
    ...
    var $author$project$Pages$Item$View$viewCountryStateButton = function(_v0) {
        var countryId = _v0.a;
        var country = _v0.b;
        var _v1 = country.countryState;
        if (_v1.$ === "Independent") return A2($elm$html$Html$button, _List_fromArray([
            $elm$html$Html$Attributes$class("bg-red-300 p-2"),
            $elm$html$Html$Events$onClick(A2($author$project$Pages$Item$Model$SetCountryState, countryId, $author$project$Pages$Item$Model$Conquered))
        ]), _List_fromArray([
            $elm$html$Html$text("Change to Conquered")
        ]));
        else return A2($elm$html$Html$button, _List_fromArray([
            $elm$html$Html$Attributes$class("bg-green-300 p-2"),
    ...
    var $author$project$Pages$Item$View$viewCountry = function(_v0) {
        var countryId = _v0.a;
        var country = _v0.b;
        ...
        if (_v1.$ === "Independent") return A2($elm$core$List$append, name, _List_fromArray([
            $elm$html$Html$text("\uD83D\uDD4A️ (Independent)"),
            $author$project$Pages$Item$View$viewCountryStateButton(_Utils_Tuple2(countryId, country))
        ]));
        else return A2($elm$core$List$append, name, _List_fromArray([
            $elm$html$Html$text("⚔️ (Conquered)"),
            $author$project$Pages$Item$View$viewCountryStateButton(_Utils_Tuple2(countryId, country))
        ]));
    };
    var $author$project$Pages$Item$View$viewCountries = function(model) {
        return A2($elm$html$Html$ol, _List_fromArray([
            ...
            var countryId = _v0.a;
            var country = _v0.b;
            return A2($elm$html$Html$li, _List_Nil, $author$project$Pages$Item$View$viewCountry(_Utils_Tuple2(countryId, country)));
        }, $elm$core$Dict$toList(model.countries)));
    };
    var $author$project$Pages$Item$View$viewPlayers = function(model) {
        return A2($elm$html$Html$ol, _List_fromArray([
            $elm$html$Html$Attributes$class("list-decimal")
        ]), A2($elm$core$List$map, function(player) {
            return A2($elm$html$Html$li, _List_Nil, _List_fromArray([
    ...
    var $author$project$Pages$Item$View$view = F3(function(language, modelBackend, model) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class("bg-gray-50 py-10")
        ]), _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class("grid grid-rows-2 max-w-3xl mx-auto")
            ]), _List_fromArray([
